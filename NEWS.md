...
* Upgrade deprecation of `docorator` and character headers to `deprecate_stop()`
...
* Export the `apply_to_gt_group` function to help apply functions to gt_group objects  (#76)
